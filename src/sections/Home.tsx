...
import cvPdf from "../assets/filePdf/NGUYEN-VAN-QUYEN_CV.pdf";
...
const Home: React.FC<HomeProps> = ({ darkMode }) => {
  ...
  const handleEmailClick = () => {
    const mailtoLink =
      "mailto:quyennv3007@gmail.com?subject=CV Inquiry from website&body=Hello, I viewed your CV website and would like to connect with you regarding an opportunity.";
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 text-center md:text-left">
        ...
        <div>
          <FadeIn delay={0.2} direction="right">
            <p className="text-xl md:text-2xl mb-2 font-semibold bg-gradient-to-r from-gray-500 to-gray-900 text-transparent bg-clip-text dark:text-white/70 ">
              {t("greeting.hello")}
            </p>
            <ShinyText
              ...
              shineColor={
                darkMode ? "rgba(255, 255, 255, 1)" : "rgba(17, 24, 39, 1)"
              }
            />
          </FadeIn>
          ...
          >
            <motion.a
              href="https://www.facebook.com/nguyen.van.quyen.678958"
              target="_blank"
              whileHover={{ scale: 1.1 }}
              className="w-10 h-10 flex items-center justify-center rounded-full border border-cyan-500 text-cyan-500"
            >
            ...
            <motion.a
              href="https://github.com/quyennv3007?tab=overview&from=2025-04-01&to=2025-04-29"
              target="_blank"
              whileHover={{ scale: 1.1 }}
              className="w-10 h-10 flex items-center justify-center rounded-full border border-cyan-500 text-cyan-500"
            >
